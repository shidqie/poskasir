    ...
    <div className={`w-full ${containerClassName}`}>
      ...
      <div className="relative rounded-lg shadow-sm">
        ...
        <input
          ...
          className={`block w-full rounded-xl border pl-11 pr-3.5 py-2.5 text-sm font-semibold text-slate-900 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:bg-slate-50 disabled:text-slate-500 ${
            error
